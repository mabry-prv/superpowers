...
Use this template when no domain-specific implementer template applies — i.e., the task touches mixed paths or paths outside the recognized layer structure (`apps/api/**`, `apps/mobile/**`).
