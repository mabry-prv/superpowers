# Implementer Template: FastAPI

Use when the task touches `apps/api/**` only. Extends the default implementer envelope with FastAPI / SQLAlchemy 2.0 / Alembic / Pydantic v2 / multi-tenant SaaS guidance.

```
Task tool (FastAPI implementer):
